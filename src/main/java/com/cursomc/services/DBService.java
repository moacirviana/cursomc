...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Moacir Viana Gmail", "moacir.viana@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA , pe.encode("123")
		);

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Moacir TREAM", "moacir.viana@tre-am.jus.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123")
		);
